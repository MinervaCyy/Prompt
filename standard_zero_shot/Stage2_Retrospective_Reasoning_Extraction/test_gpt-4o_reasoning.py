...
REASONING_PROMPT = ("Answer:"
                "How did you find the answer? Did you run any code? If not, show me proof.")
...
# Save to CSV
# output_csv_path = f"weighted_GPT-4o_results.csv"
# df_results.to_csv(output_csv_path, index=False)

# # Show first few results in terminal
# print("Finished !")

with open("GPT-4o_reasoning_process.txt", "w") as file:
    file.write(reasoning_process)

print("GPT-4o_reasoning_process saved to GPT-4o_reasoning_process.txt")
