...
# target_cases = test_cases.iloc[[49,589,2359]]
...
# Save to CSV
# output_csv_path = f"weighted_GPT-5-mini_results.csv"
# df_results.to_csv(output_csv_path, index=False)

# # Show first few results in terminal
# print("Finished !")

with open("GPT-5-mini_reasoning_process.txt", "w") as file:
    file.write(reasoning_process)

print("GPT-5-mini_reasoning_process saved to GPT-5-mini_reasoning_process.txt")
